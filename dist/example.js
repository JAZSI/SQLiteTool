...
async function example() {
    ...
    const db = new index_1.SQLiteTool('./example.sqlite', {
        logging: true,
        verbose: true
    });
    try {
        ...
        await db.update('users', { age: 31, updated_at: new Date().toISOString() }, { username: 'john_doe' });
        // Update multiple records
        await db.update('users', { is_active: false }, { age: { operator: '<', value: 18 } });
        // ==================== DELETE EXAMPLES ====================
        ...
        const admin = new index_1.SQLiteAdmin(db);
        ...
        const query = new index_1.QueryBuilder('users')
